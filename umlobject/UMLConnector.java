...
public class UMLConnector extends UMLObject {
	 ...
	 * Basic Constructor
	 * 
	 * @param inStart UMLNode whose origin coordinates this's underlying line will
	 * start at.
	 * 
	 * @param inStop UMLNode whose origin coordinates this's underlying line will
	 * stop at.
	 * 
	 * @postcondition UMLConnector instance with given starting and stopping
	 * UMLNodes is created.
	 */
	...
	/*
	 * "Redraws" underlying Line model to be between starting and stopping UMLNodes.
	 * Used when the * starting and or the stopping UMLNode has been moved.
	 * 
	 * @postcondition Underlying line model is reassigned to current coordinates of
	 * starting and * stopping UMLNodes.
	 */
	public void update() {
		selfType = ObjectType.CONNECTOR;
